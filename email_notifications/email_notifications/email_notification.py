...
#the run id has to be common for all of the sources so that mail for all of the run id goes to the client ;
...
#convert the above table to html table; 
...
<b>customersupport@tulover.org</b>
</p>
...
subject = f"Tulover Neobank | {overall_status} | End to End Run"
...
EMAIL = "ayushdhungana204@gmail.com"
APP_PASSWORD = gmail_api_key

to_email = "ayushdhungana204@gmail.com"
