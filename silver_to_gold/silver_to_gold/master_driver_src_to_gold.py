...
try:
    ...
    #when the individual notebooks exit with a certain value, it is returned to the calling notebook which means the value is stored in the 'result' variable above ; 
