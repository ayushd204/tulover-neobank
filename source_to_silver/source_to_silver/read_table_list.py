...
#using list comprehensions to get the table data in json format ;

print("Tables to Process (Full Metadata):")
# print(tables_list)
# the output of this notebook has to be in the form of json so that it could be used by another notebook ; 
